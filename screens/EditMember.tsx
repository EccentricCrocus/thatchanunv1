...
const EditMember = ({ navigation, route }: { navigation: any; route: any }) => {
  ...
  const fetchMembers = () => {
    ...
    setSex(user.sex_mem.toString());
    setBirthday(new Date(user.birthday_mem));
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert('Success', 'Member edited successfully');
              navigation.goBack();
            } catch (error) {
              Alert.alert('Error', 'Failed to edit member');
            }
          },
        },
      ],
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity style={styles.addButton} onPress={handleEdit}>
        <Text style={styles.addButtonText}>Edit Member</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.delButton} onPress={handleDel}>
        <Text style={styles.addButtonText}>Delete Member</Text>
      </TouchableOpacity>
    </ScrollView>
  );
};
